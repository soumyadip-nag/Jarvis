...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "why", "which", "whose", "whom", "can you", "what's", "where's", "how's", "can't you", "do you", "don't you", "are you", "aren't you", "did you", "didn't you", "will you", "would you", "won't you", "wouldn't you", "shall you", "should you", "shouldn't you", "have you", "haven't you"]
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()  # Corrected constructor name and call
